...
class GNUGlobal:
    ...
    def gtags(cls, srcdir: str, tagdir: str | None = None):
        ...
        """
        if _use_tempdir := tagdir is None:
            tagdir = tempfile.mkdtemp()
        ...
        return cls(tagdir, _remove_on_destruct=_use_tempdir)
